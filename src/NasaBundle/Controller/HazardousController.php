...
use NasaBundle\Service\NearEarthObjectService;
...
class HazardousController extends Controller
{
     ...
     * @param NearEarthObjectService $service
     */
    public function __construct(ResponseFactoryInterface $responseFactory, NearEarthObjectService $service)
    {
